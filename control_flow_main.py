...
def main(lower_level, render, lower_level_load_path, max_eval_lines, **kwargs):
    ...
    class ControlFlowTrainer(Trainer):
        ...
        @staticmethod
        def make_env(seed, rank, evaluation, env_id=None, **args):
            args.update(seed=seed + rank, rank=rank, lower_level=lower_level)
            if not lower_level:
    ...
    ControlFlowTrainer.main(**kwargs, render=render)
