...
def bandit_args():
    ...
    parser.add_argument("--baseline", choices=["default", "simple"])
    ...
    parsers.agent.add_argument("--append-first", type=bool, required=True)
    parsers.agent.add_argument("--roll-P", type=bool, required=True)
