...
def exp_cli():
    ...
    gridworld_parser.add_argument("--dog-speed", help="", type=float, default=0.01)
    gridworld_parser.add_argument("--cat-speed", help="", type=float, default=0.01)
    gridworld_parser.add_argument("--fly-speed", help="", type=float, default=0.005)
