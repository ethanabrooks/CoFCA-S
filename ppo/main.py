...
def train_blocks_world(increment_curriculum_at_n_satisfied, baseline, **_kwargs):
    class TrainValues(Train):
        ...
        def make_env(
            ...
            if baseline == "dnc":
                ...
                return non_recurrent.Env(**env_args, seed=seed + rank)
            else:
...
def blocks_world_cli():
    ...
    parsers.env.add_argument("--search-depth", type=int)
    ...
    planner_parser.add_argument("--planning-steps", type=int)
